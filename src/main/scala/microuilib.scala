...
object types:
  ...
  object mu_Container:
    given _tag: Tag[mu_Container] = Tag.materializeCStruct8Tag[Ptr[mu_Command], Ptr[mu_Command], mu_Rect, mu_Rect, mu_Vec2, mu_Vec2, CInt, CInt]
    def apply()(using Zone): Ptr[mu_Container] = scala.scalanative.unsafe.alloc[mu_Container](1)
    def apply(head : Ptr[mu_Command], tail : Ptr[mu_Command], rect : mu_Rect, body : mu_Rect, content_size : mu_Vec2, scroll : mu_Vec2, zindex : CInt, open : CInt)(using Zone): Ptr[mu_Container] = 
      val ____ptr = apply()
      (!____ptr).head = head
      (!____ptr).tail = tail
      (!____ptr).rect = rect
  ...
  object mu_Context:
    ...
    object Struct0:
      given _tag: Tag[Struct0] = Tag.materializeCStruct2Tag[CInt, CArray[CChar, Nat.Digit6[Nat._2, Nat._6, Nat._2, Nat._1, Nat._4, Nat._4]]]
      def apply()(using Zone): Ptr[Struct0] = scala.scalanative.unsafe.alloc[Struct0](1)
      def apply(idx : CInt, items : CArray[CChar, Nat.Digit6[Nat._2, Nat._6, Nat._2, Nat._1, Nat._4, Nat._4]])(using Zone): Ptr[Struct0] = 
        val ____ptr = apply()
        (!____ptr).idx = idx
        (!____ptr).items = items
        ____ptr
      extension (struct: Struct0)
        ...
        def items_=(value: CArray[CChar, Nat.Digit6[Nat._2, Nat._6, Nat._2, Nat._1, Nat._4, Nat._4]]): Unit = !struct.at2 = value
    ...
    given _tag: Tag[mu_Context] = Tag.CArray[CChar, Nat.Digit6[Nat._2, Nat._7, Nat._0, Nat._2, Nat._0, Nat._0]](Tag.Byte, Tag.Digit6[Nat._2, Nat._7, Nat._0, Nat._2, Nat._0, Nat._0](Tag.Nat2, Tag.Nat7, Tag.Nat0, Tag.Nat2, Tag.Nat0, Tag.Nat0))
    def apply()(using Zone): Ptr[mu_Context] = scala.scalanative.unsafe.alloc[mu_Context](1)
    def apply(text_width : CFuncPtr3[mu_Font, CString, CInt, CInt], text_height : CFuncPtr1[mu_Font, CInt], draw_frame : CFuncPtr3[Ptr[mu_Context], mu_Rect, CInt, Unit], _style : mu_Style, style : Ptr[mu_Style], hover : mu_Id, focus : mu_Id, last_id : mu_Id, last_rect : mu_Rect, last_zindex : CInt, updated_focus : CInt, frame : CInt, hover_root : Ptr[mu_Container], next_hover_root : Ptr[mu_Container], scroll_target : Ptr[mu_Container], number_edit_buf : CArray[CChar, Nat.Digit3[Nat._1, Nat._2, Nat._7]], number_edit : mu_Id, command_list : mu_Context.Struct0, root_list : mu_Context.Struct1, container_stack : mu_Context.Struct2, clip_stack : mu_Context.Struct3, id_stack : mu_Context.Struct4, layout_stack : mu_Context.Struct5, container_pool : CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]], containers : CArray[mu_Container, Nat.Digit2[Nat._4, Nat._8]], treenode_pool : CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]], mouse_pos : mu_Vec2, last_mouse_pos : mu_Vec2, mouse_delta : mu_Vec2, scroll_delta : mu_Vec2, mouse_down : CInt, mouse_pressed : CInt, key_down : CInt, key_pressed : CInt, input_text : CArray[CChar, Nat.Digit2[Nat._3, Nat._2]])(using Zone): Ptr[mu_Context] = 
      val ____ptr = apply()
    ...
    extension (struct: mu_Context)
      def text_width: CFuncPtr3[mu_Font, CString, CInt, CInt] = !struct.at(0).asInstanceOf[Ptr[CFuncPtr3[mu_Font, CString, CInt, CInt]]]
      def text_width_=(value: CFuncPtr3[mu_Font, CString, CInt, CInt]): Unit = !struct.at(0).asInstanceOf[Ptr[CFuncPtr3[mu_Font, CString, CInt, CInt]]] = value
      def text_height: CFuncPtr1[mu_Font, CInt] = !struct.at(8).asInstanceOf[Ptr[CFuncPtr1[mu_Font, CInt]]]
      def text_height_=(value: CFuncPtr1[mu_Font, CInt]): Unit = !struct.at(8).asInstanceOf[Ptr[CFuncPtr1[mu_Font, CInt]]] = value
      def draw_frame: CFuncPtr3[Ptr[mu_Context], mu_Rect, CInt, Unit] = !struct.at(16).asInstanceOf[Ptr[CFuncPtr3[Ptr[mu_Context], mu_Rect, CInt, Unit]]]
      def draw_frame_=(value: CFuncPtr3[Ptr[mu_Context], mu_Rect, CInt, Unit]): Unit = !struct.at(16).asInstanceOf[Ptr[CFuncPtr3[Ptr[mu_Context], mu_Rect, CInt, Unit]]] = value
      ...
      def next_hover_root_=(value: Ptr[mu_Container]): Unit = !struct.at(176).asInstanceOf[Ptr[Ptr[mu_Container]]] = value
      ...
      def number_edit_buf: CArray[CChar, Nat.Digit3[Nat._1, Nat._2, Nat._7]] = !struct.at(192).asInstanceOf[Ptr[CArray[CChar, Nat.Digit3[Nat._1, Nat._2, Nat._7]]]]
      def number_edit_buf_=(value: CArray[CChar, Nat.Digit3[Nat._1, Nat._2, Nat._7]]): Unit = !struct.at(192).asInstanceOf[Ptr[CArray[CChar, Nat.Digit3[Nat._1, Nat._2, Nat._7]]]] = value
      ...
      def command_list_=(value: mu_Context.Struct0): Unit = !struct.at(324).asInstanceOf[Ptr[mu_Context.Struct0]] = value
      def root_list: mu_Context.Struct1 = !struct.at(262472).asInstanceOf[Ptr[mu_Context.Struct1]]
      def root_list_=(value: mu_Context.Struct1): Unit = !struct.at(262472).asInstanceOf[Ptr[mu_Context.Struct1]] = value
      def container_stack: mu_Context.Struct2 = !struct.at(262736).asInstanceOf[Ptr[mu_Context.Struct2]]
      def container_stack_=(value: mu_Context.Struct2): Unit = !struct.at(262736).asInstanceOf[Ptr[mu_Context.Struct2]] = value
      def clip_stack: mu_Context.Struct3 = !struct.at(263000).asInstanceOf[Ptr[mu_Context.Struct3]]
      def clip_stack_=(value: mu_Context.Struct3): Unit = !struct.at(263000).asInstanceOf[Ptr[mu_Context.Struct3]] = value
      ...
      def layout_stack_=(value: mu_Context.Struct5): Unit = !struct.at(263648).asInstanceOf[Ptr[mu_Context.Struct5]] = value
      def container_pool: CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]] = !struct.at(265892).asInstanceOf[Ptr[CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]]]]
      def container_pool_=(value: CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]]): Unit = !struct.at(265892).asInstanceOf[Ptr[CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]]]] = value
      def containers: CArray[mu_Container, Nat.Digit2[Nat._4, Nat._8]] = !struct.at(266280).asInstanceOf[Ptr[CArray[mu_Container, Nat.Digit2[Nat._4, Nat._8]]]]
      def containers_=(value: CArray[mu_Container, Nat.Digit2[Nat._4, Nat._8]]): Unit = !struct.at(266280).asInstanceOf[Ptr[CArray[mu_Container, Nat.Digit2[Nat._4, Nat._8]]]] = value
      def treenode_pool: CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]] = !struct.at(269736).asInstanceOf[Ptr[CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]]]]
      def treenode_pool_=(value: CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]]): Unit = !struct.at(269736).asInstanceOf[Ptr[CArray[mu_PoolItem, Nat.Digit2[Nat._4, Nat._8]]]] = value
      ...
      def input_text: CArray[CChar, Nat.Digit2[Nat._3, Nat._2]] = !struct.at(270168).asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._3, Nat._2]]]]
      def input_text_=(value: CArray[CChar, Nat.Digit2[Nat._3, Nat._2]]): Unit = !struct.at(270168).asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._3, Nat._2]]]] = value
  ...
  opaque type mu_Layout = CStruct11[mu_Rect, mu_Rect, mu_Vec2, mu_Vec2, mu_Vec2, CArray[CInt, Nat.Digit2[Nat._1, Nat._6]], CInt, CInt, CInt, CInt, CInt]
  object mu_Layout:
    given _tag: Tag[mu_Layout] = Tag.materializeCStruct11Tag[mu_Rect, mu_Rect, mu_Vec2, mu_Vec2, mu_Vec2, CArray[CInt, Nat.Digit2[Nat._1, Nat._6]], CInt, CInt, CInt, CInt, CInt]
    def apply()(using Zone): Ptr[mu_Layout] = scala.scalanative.unsafe.alloc[mu_Layout](1)
    def apply(body : mu_Rect, next : mu_Rect, position : mu_Vec2, size : mu_Vec2, max : mu_Vec2, widths : CArray[CInt, Nat.Digit2[Nat._1, Nat._6]], items : CInt, item_index : CInt, next_row : CInt, next_type : CInt, indent : CInt)(using Zone): Ptr[mu_Layout] = 
      val ____ptr = apply()
      (!____ptr).body = body
      (!____ptr).next = next
  ...
  opaque type mu_Style = CStruct9[mu_Font, mu_Vec2, CInt, CInt, CInt, CInt, CInt, CInt, CArray[mu_Color, Nat.Digit2[Nat._1, Nat._4]]]
  object mu_Style:
    given _tag: Tag[mu_Style] = Tag.materializeCStruct9Tag[mu_Font, mu_Vec2, CInt, CInt, CInt, CInt, CInt, CInt, CArray[mu_Color, Nat.Digit2[Nat._1, Nat._4]]]
    def apply()(using Zone): Ptr[mu_Style] = scala.scalanative.unsafe.alloc[mu_Style](1)
    def apply(font : mu_Font, size : mu_Vec2, padding : CInt, spacing : CInt, indent : CInt, title_height : CInt, scrollbar_size : CInt, thumb_size : CInt, colors : CArray[mu_Color, Nat.Digit2[Nat._1, Nat._4]])(using Zone): Ptr[mu_Style] = 
      val ____ptr = apply()
      (!____ptr).font = font
      (!____ptr).size = size
  ...
  object mu_TextCommand:
    given _tag: Tag[mu_TextCommand] = Tag.materializeCStruct5Tag[mu_BaseCommand, mu_Font, mu_Vec2, mu_Color, CArray[CChar, Nat._1]]
    def apply()(using Zone): Ptr[mu_TextCommand] = scala.scalanative.unsafe.alloc[mu_TextCommand](1)
    def apply(base : mu_BaseCommand, font : mu_Font, pos : mu_Vec2, color : mu_Color, str : CArray[CChar, Nat._1])(using Zone): Ptr[mu_TextCommand] = 
      val ____ptr = apply()
      (!____ptr).base = base
      (!____ptr).font = font
      (!____ptr).pos = pos
...
private[microuilib] object extern_functions:
  ...
  private[microuilib] def __sn_wrap_microuilib_mu_color(r : CInt, g : CInt, b : CInt, a : CInt, __return : Ptr[mu_Color]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_draw_box(ctx : Ptr[mu_Context], rect : Ptr[mu_Rect], color : Ptr[mu_Color]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_draw_control_frame(ctx : Ptr[mu_Context], id : mu_Id, rect : Ptr[mu_Rect], colorid : CInt, opt : CInt): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_draw_control_text(ctx : Ptr[mu_Context], str : CString, rect : Ptr[mu_Rect], colorid : CInt, opt : CInt): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_draw_icon(ctx : Ptr[mu_Context], id : CInt, rect : Ptr[mu_Rect], color : Ptr[mu_Color]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_draw_rect(ctx : Ptr[mu_Context], rect : Ptr[mu_Rect], color : Ptr[mu_Color]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_draw_text(ctx : Ptr[mu_Context], font : mu_Font, str : CString, len : CInt, pos : Ptr[mu_Vec2], color : Ptr[mu_Color]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_get_clip_rect(ctx : Ptr[mu_Context], __return : Ptr[mu_Rect]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_layout_next(ctx : Ptr[mu_Context], __return : Ptr[mu_Rect]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_layout_set_next(ctx : Ptr[mu_Context], r : Ptr[mu_Rect], relative : CInt): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_mouse_over(ctx : Ptr[mu_Context], rect : Ptr[mu_Rect]): CInt = extern

  private[microuilib] def __sn_wrap_microuilib_mu_push_clip_rect(ctx : Ptr[mu_Context], rect : Ptr[mu_Rect]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_rect(x : CInt, y : CInt, w : CInt, h : CInt, __return : Ptr[mu_Rect]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_set_clip(ctx : Ptr[mu_Context], rect : Ptr[mu_Rect]): Unit = extern

  private[microuilib] def __sn_wrap_microuilib_mu_textbox_raw(ctx : Ptr[mu_Context], buf : CString, bufsz : CInt, id : mu_Id, r : Ptr[mu_Rect], opt : CInt): CInt = extern

  private[microuilib] def __sn_wrap_microuilib_mu_update_control(ctx : Ptr[mu_Context], id : mu_Id, rect : Ptr[mu_Rect], opt : CInt): Unit = extern
  ...
  def mu_slider_ex(ctx : Ptr[mu_Context], value : Ptr[mu_Real], low : mu_Real, high : mu_Real, step : mu_Real, fmt : CString, opt : CInt): CInt = extern
...
object functions:
  ...
  def mu_draw_control_frame(ctx : Ptr[mu_Context], id : mu_Id, rect : mu_Rect, colorid : CInt, opt : CInt)(using Zone): Unit = 
    val __ptr_0: Ptr[mu_Rect] = alloc[mu_Rect](1)
    !(__ptr_0 + 0) = rect
  ...
  def mu_draw_control_text(ctx : Ptr[mu_Context], str : CString, rect : mu_Rect, colorid : CInt, opt : CInt)(using Zone): Unit = 
    val __ptr_0: Ptr[mu_Rect] = alloc[mu_Rect](1)
    !(__ptr_0 + 0) = rect
  ...
  def mu_draw_text(ctx : Ptr[mu_Context], font : mu_Font, str : CString, len : CInt, pos : Ptr[mu_Vec2], color : Ptr[mu_Color]): Unit = 
    __sn_wrap_microuilib_mu_draw_text(ctx, font, str, len, pos, color)

  def mu_draw_text(ctx : Ptr[mu_Context], font : mu_Font, str : CString, len : CInt, pos : mu_Vec2, color : mu_Color)(using Zone): Unit = 
